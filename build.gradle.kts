...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-doc", "1.1.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-doc")
        description.set("kotlin-doc")
        url.set("https://github.com/wabbit-corp/kotlin-doc")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-doc")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-doc.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-doc.git")
        }
    }
}
...
dokka {
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-doc/tree/master/src")
